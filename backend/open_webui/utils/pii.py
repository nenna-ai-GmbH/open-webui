...
def _resolve_overlaps(replacements: list[dict], modifier_entities: set[str]) -> list[dict]:
	"""
...
def text_masking(text: str, pii_list: list[dict] | list[object], modifiers: list[dict | object] | None) -> str:
	"""
	...
	if modifiers:
		for modifier in modifiers:
			...
			entity = modifier.entity if hasattr(modifier, 'entity') else modifier.get('entity')
			if entity:
