...
def test_unmask_messages_realistic_conversation():
    ...
    assert (
        result[0]["content"]
        == "What projects has Dr. Sarah Johnson worked on at Research Institute?"
    )
    assert (
        result[1]["content"]
        == "Dr. Sarah Johnson has led several initiatives at Research Institute."
    )
    assert (
        result[2]["content"]
        == "Can you tell me more about their work in Silicon Valley?"
    )
