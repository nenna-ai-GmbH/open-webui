 ...
 * ```
 */
export const maskUpdateTextMaskUpdatePost = <ThrowOnError extends boolean = false>(options: Options<MaskUpdateTextMaskUpdatePostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<MaskUpdateTextMaskUpdatePostResponses, MaskUpdateTextMaskUpdatePostErrors, ThrowOnError>({
        security: [
            {
                name: 'X-API-Key',
                type: 'apiKey'
