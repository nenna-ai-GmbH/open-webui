...
class MockHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        print(f"Path: {self.path}")
        print(f"Headers: {dict(self.headers)}")
        print(f"Body: {json.dumps(json.loads(body), indent=2) if body else 'Empty body'}")
        print("="*60)
        ...
        response = {
            ...
            "choices": [{
                ...
                "message": {
                    "role": "assistant",
                    "content": "Request received: " + (json.dumps(json.loads(body), indent=2) if body else 'Empty body')
                },
                "finish_reason": "stop"
            }],
            "usage": {
